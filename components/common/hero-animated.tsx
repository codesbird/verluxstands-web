        ...
        <div className="relative isolate min-h-[620px] overflow-hidden px-4 py-10 sm:px-8 lg:px-12 lg:py-5">
          <div className="absolute inset-0 -z-20">
            <div className={`absolute inset-0 transition-opacity duration-1000`}>
              <Image src={heroImages} alt="Exhibition stand environment" fill className="object-cover" />
            </div>
          </div>

          {/* <div className="absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(8,8,8,0.65),rgba(8,8,8,0.72)),radial-gradient(circle_at_top,rgb(59, 52, 40))]" /> */}
