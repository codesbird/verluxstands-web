...
export default function Testimonials() {
  const testimonials = [
    ...
    {
      content:
        "I can't recommend Verlux Stands highly enough! Their team was great to work with, and the stand they built for us was top-notch. The attention to detail, timely execution, and commitment to meeting our requirements made a huge difference.",
      author: "John M.",
